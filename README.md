...
**Oversampling setting**: see also chapter 3.4.1 ...3.4.3 in datasheet.<br>With this setting you define how is the measurement done.<br>No oversampling means the measurement is skipped, no measurement is done.<br>Oversampling rates of x1...x16 defined how many measurements are taken.<br>x1 means one shot measurement, x2 means average of two measurements and x16 means average of 16 measurements.<br>The higher the oversampling rate the higher the current consumption of the sensor but the lower the signal noise.
